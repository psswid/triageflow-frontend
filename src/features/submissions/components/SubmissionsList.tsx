    ...
    <div className="overflow-x-auto">
      <table className="w-full text-left text-sm text-gray-700 dark:text-gray-300">
        <thead className="border-b border-gray-200 dark:border-gray-700 text-xs uppercase text-gray-500 dark:text-gray-400">
          <tr>
            <th className="px-4 py-3 font-medium">{t('submissions.table.status')}</th>
            <th className="px-4 py-3 font-medium">{t('submissions.table.specialist')}</th>
            <th className="px-4 py-3 font-medium">{t('submissions.table.urgency')}</th>
            <th className="px-4 py-3 font-medium">{t('submissions.table.synthetic', 'Turns')}</th>
            <th className="px-4 py-3 font-medium">{t('submissions.table.date')}</th>
            <th className="px-4 py-3 font-medium">{t('submissions.table.actions')}</th>
          </tr>
        </thead>
            ...
            >
              ...
              <td className="px-4 py-3">
                {submission.attributes.status !== 'failed' ? (
                  ...
                  >
                    {submission.attributes.status === 'completed' ? t('submissions.viewResult') : t('submissions.viewDetails')}
                  </Link>
                ) : (
